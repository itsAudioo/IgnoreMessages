...
<p align="center">
  ...
  <img src="https://img.shields.io/github/downloads/itsAudioo/IgnoreMessages/total" alt="Downloads">
  <img src="https://img.shields.io/github/stars/itsAudioo/IgnoreMessages?style=flat&logo=github" alt="Stars">
  <img src="https://img.shields.io/github/license/itsAudioo/IgnoreMessages" alt="License">
</p>

# 🧑‍💻 Credits

- Original plugin concept & CSS implementation:
  [KillStr3aK](https://github.com/KillStr3aK/IgnoreMessages)

- SwiftlyS2 port:
  [itsAudio](https://github.com/itsAudioo)

# 📦 Installation

- Download or build the plugin DLL

- Place it into your SwiftlyS2 plugins directory:

`swiftlys2/plugins/IgnoreMessages/`

- Start or restart the server

- Configuration file will be generated automatically:
  `swiftlys2/plugins/IgnoreMessages/IgnoreMessages.json`
...
- IgnoredMessages
  A list of localization keys that should be blocked.
